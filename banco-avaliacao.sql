...
INSERT INTO HUMANO ( nome, grupo, nascimento, clube, cor_favorita, profissao, nacionalidade, habilitado, sexo, filme)
VALUES
...
("Fabio", "c",  "1997-07-07", "delta", "verde", "Cosplay", "japonesa", "s", "m", "Tubarao"),
("Fabricio", "d", "1996-08-08", "pi", "vermelho", "Guarda Costas", "brasileira", "s", "m", "Milagre"),
("Gabriel", "a",  "1995-09-10", "alpha", "azul", "Mecanico", "chinesa", "s", "m", "Bola"),
...
("Gustavo", "b",  "2001-02-14", "beta", "rosa", "Jogador Golge", "japonesa", "s", "m", "Tubarao"),
...
("Joao", "a",  "1997-05-17", "alpha", "azul", "Mecanico", "italiana", "n", "m", "Fenix"),
...
("Kaiky", "a",  "2003-09-21", "alpha", "azul", "Jogador de Futebol", "japonesa", "s", "m", "Tubarao"),
...
("Lucas", "a", "2000-01-25", "alpha", "azul", "Mecanico", "portuguesa", "s", "m", "Pegasos"),
...
("Matheus", "d",  "1996-04-28", "pi", "vermelho", "Guitarrista", "japonesa", "s", "m", "Tubarao"),
...
("Nathaly", "d", "2001-08-01", "pi", "vermelho", "Guarda Costas", "portuguesa", "s", "f", "Pegasos"),
("Nicholas", "a",  "2001-09-02", "alpha", "azul", "Mecanico", "colombiana", "s", "m", "Barco"),
("Nickolas", "b",  "2000-10-03", "beta", "rosa", "Motorista", "americana", "s", "m", "Abelhas"),
("Paulo", "c",  "1999-11-04", "delta", "verde", "Manobrista", "japonesa", "n", "m", "Tubarao"),
